...
AWS_ACCOUNT_ID=`aws sts get-caller-identity --profile awsinfra \
...
GH_ACCESS_TOKEN=$(cat ~/.github/aws-infra-access-token) 
GH_OWNER=$(cat ~/.github/aws-infra-owner)
GH_REPO=$(cat ~/.github/aws-infra-repo) 
GH_BRANCH=master
